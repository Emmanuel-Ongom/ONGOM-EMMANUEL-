      ...
      if (client.available()) {
        ...
        if (c == '\n') {
          if (currentLine.length() == 0) {
            ...
            client.println("<!DOCTYPE html><html><head><title>Emma Systems Lighting</title>");
            ...
            client.println("<h1>Emma Systems</h1>");
            ...
            client.println("</div>");
            client.println("<footer>&copy; 2025 Emmanuel Ongom| Team Innovators</footer>");
